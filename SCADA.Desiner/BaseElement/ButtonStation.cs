...
namespace SCADA.Desiner.BaseElement
{
    ...
    /// </summary>
    class ButtonStation : Shape, IGraficObejct, IFreeAngle, IScrollElement
    {
        ...
        private string nameobject = "Кнопка станции";
        /// <summary>
        /// название объекта
        /// </summary>
        ...
        /// </summary>
        Brush _colordefult = Brushes.LightGreen;
        /// <summary>
        ...
        ViewElement viewElement = ViewElement.buttonstation;
        /// <summary>
        /// Вид элемента
        /// </summary>
        ...
        public ButtonStation(double kscroll, int stationnumber, double X, double Y)
        {
            StationNumber = stationnumber;
            GeometryFigure(kscroll, X, Y);
        }

        public ButtonStation(int stationnumber, PathGeometry geometry, double strokethickness, string name, double currencyScroll)
        {
            NameObject = name;
