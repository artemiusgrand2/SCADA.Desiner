...
namespace SCADA.Desiner.BaseElement
{
    ...
    /// <summary>
    /// класс описывающий маневровый светофор
    /// </summary>
    class LightShunting : Shape, IGraficObejct, IScrollElement, IFreeAngle
    {
        ...
        private string nameobject = "Маневровый светофор";
        /// <summary>
        /// название объекта
        /// </summary>
        ...
        ViewElement viewElement = ViewElement.lightShunting;
        /// <summary>
        /// Вид элемента
        /// </summary>
        ...
        public LightShunting(double kscroll, int stationnumber, double X, double Y)
        {
        ...
        public LightShunting(int stationnumber, PathGeometry geometry, double strokethickness, string name, double currencyScroll)
        {
